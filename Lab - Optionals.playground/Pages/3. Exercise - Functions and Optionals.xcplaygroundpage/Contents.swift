...
func checkItem (itemName:String) -> Double? {
    if stock[itemName]! > 0 {
...
print(checkItem(itemName: "Chips"))
print(checkItem(itemName: "Donuts"))
print(checkItem(itemName: "Apple"))
