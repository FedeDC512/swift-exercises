 ...
 */
var statesAndCapitals: [String: String] = ["Italy":"Rome", "France":"Paris", "Spain":"Madrid"]
for element in statesAndCapitals {
    if element.key == "Italy" {
        print("I found my home: \(element.key)!")
    }
}
