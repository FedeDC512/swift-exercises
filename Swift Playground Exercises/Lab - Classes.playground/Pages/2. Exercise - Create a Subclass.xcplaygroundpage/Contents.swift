 ...
 */
//print(falcon.weapon)
print("The code does not compile because the instance of falcon was decleared in a different file")
/*:
 ...
 */
print("Remaining Fire: \(destroyer.remainingFirePower)")
destroyer.fire()
print("Remaining Fire: \(destroyer.remainingFirePower)")
destroyer.fire()
print("Remaining Fire: \(destroyer.remainingFirePower)")
