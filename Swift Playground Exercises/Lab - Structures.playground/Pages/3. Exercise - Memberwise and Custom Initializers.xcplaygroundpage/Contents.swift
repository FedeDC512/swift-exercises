...
var favoriteBook = Book(title: "The Song of Achilles", author: "Madeline Miller", pages: 368, price: 10)
...
print("\(someonesHeight.heightInInches) inches, \(someonesHeight.heightInCentimeters) cm")
/*:
...
print("\(myHeight.heightInInches) inches, \(myHeight.heightInCentimeters) cm")
