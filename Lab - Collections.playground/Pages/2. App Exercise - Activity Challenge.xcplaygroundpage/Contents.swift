 ...
 */
var walkingChallenges: [String] = ["Walk 3 miles a day", "Walk 21 miles a week"]
var runningChallenges: [String] = ["Run 1 time a day", "Run 7 times a week"]
/*:
...
if committedChallenges.isEmpty {
    print("You have not completed any challenge today, why don't you commit a challenge?")
} else if committedChallenges.count == 1 {
    print("The challenge you have chosen is \(committedChallenges)")
} else {
