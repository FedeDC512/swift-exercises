...
var myWorkout = RunningWorkout(distance: 3000, time: 12, elevation: 200)
...
struct Steps {
    var steps: Int {
        willSet{
            if steps + 1 == goal {
                print("Congratulation! You have reacher your step goal!")
            }
        }
    }
    var goal: Int
...
var myPedometer = Steps(steps: 9999, goal: 10_000)
