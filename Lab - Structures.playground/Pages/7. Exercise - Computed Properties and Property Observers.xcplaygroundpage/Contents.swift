...
var myRectangle = Rectangle(width: 2, height: 6)
...
var person = Height(heightInCentimeters: 180)
print("\(person.heightInCentimeters)cm \(person.heightInInches)inches")
person.heightInInches = 90
print("\(person.heightInCentimeters)cm \(person.heightInInches)inches")
person.heightInCentimeters = 160
print("\(person.heightInCentimeters)cm \(person.heightInInches)inches")
