 ...
 */
var fede = User(name: "Federico", age: 22, height: 160, weight: 60, activityLevel: 1)
print("\(fede.name), age \(fede.age), height \(fede.height), weight \(fede.weight), level \(fede.activityLevel)")
/*:
 ...
 */
var america = Distance(feet: 5249.344)
print(america.meter)
